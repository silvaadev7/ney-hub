...
local Window = Libary:MakeWindow({
    Title = "ney Hub | Brookhaven RP 🏡",
    SubTitle = "by: silvadev e kauandev",
    LoadText = "Carregando ney hub",
    Flags = "ney_Broookhaven"
})
...
InfoTab:AddParagraph({ "Proprietário / Desenvolvedor:", "Silvadev e kauandev " })
InfoTab:AddParagraph({ "Collaborations:", "anonymus team " }) 
InfoTab:AddParagraph({ "obfuscador:", "?????????" })
InfoTab:AddParagraph({ "Segurança:", "Silvadev" })
InfoTab:AddParagraph({ "Você está usando:", "ney hub Brookhaven " })
...
local TabEvento = Window:MakeTab({
    Title = "Evento",
    Icon = "rbxassetid://4483362458" 
})

local SectionEvento = TabEvento:AddSection({
    Name = "Eventos"
})

TabEvento:AddButton({
    Name = "Auto Farm by anonymus hub",
    Callback = function()
        print("Auto Farm Evento Natal ativado")
        loadstring(game:HttpGet("https://raw.githubusercontent.com/Frost230/Embee/refs/heads/main/Natal%20!"))()
    end
})
...
logoImage.Image = "rbxassetid://131123059563272"
